(function () {
    ...
    // ========================================
    // INTERSECTION OBSERVER â€” DASHBOARD BARS
    // ========================================
    ...
    if (waitlistForm) {
        waitlistForm.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                btn.textContent = 'âœ“ Added to waitlist';
    ...
    // ========================================
    // MOBILE STICKY CTA â€” SHOW/HIDE ON SCROLL
    // ========================================
    ...
    // ========================================
    // HERO SECTION â€” ALSO HIDE STICKY CTA
    // ========================================
    ...
    // ========================================
    // HERO WAITLIST BUTTON â€” DOG SPRINT ANIMATION
    // ========================================
    (function () {
        ...
        function onDogArrived() {
            ...
            // Scroll to form, then reset button back to idle state
            setTimeout(function () {
                scrollToWaitlistForm();
                setTimeout(function () {
                    heroBtn.classList.remove('ww-btn--confirmed');
                }, 600);
            }, 220);
        }
